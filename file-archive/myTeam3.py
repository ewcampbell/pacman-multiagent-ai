...
def createTeam(firstIndex, secondIndex, isRed):
    ...
    return [
        OffenseOne(firstIndex, training=False),
        OffenseTwo(secondIndex, training=False),
    ]

class OffenseOne(CaptureAgent):
    """
    Agent one for offense-centric team.
    ...
    def getInitialWeights(self):
        ...
        """
        return {
            "bias": 1.9333821853203637,
            "distanceToFood": -3.910646588351382,
            "distanceToGhost": -3.138218741483276,
            "foodDensity": 1.6153675173132824,
            "scaredGhostProximity": 3.0985766456647545,
            "powerCapsuleDistance": -0.08817590122457603,
            "ghostScaredTime": 2.8814762033234933,
            "avoidDeadEnds": 0.2533695714536659,
            "stop": -1.1797792622473358
        }
...
class OffenseTwo(CaptureAgent):
    ...
    def getInitialWeights(self):
        ...
        """
        return {
            "bias": 0.5881393824570449,
            "distanceToFood": -2.1542525676898285,
            "distanceToGhost": -2.0265213733051928,
            "foodDensity": 1.3534428214564906,
            "scaredGhostProximity": 3.132877872781007,
            "powerCapsuleDistance": 0.0951773227416226,
            "ghostScaredTime": 1.9296459108044468,
            "avoidDeadEnds": 0.8047185009741834,
            "stop": -0.9240088422870872
        }
